...
preflight(){
    output "Script em desenvolvimento"
    output "Copyright © 2020 _SrDavi."
    output "Não repasse esse script"
    output ""

    output "Script feito para a switehosting"
    output "Iniciando instalação.."
    ...
    output "Detecção de virtualização automática inicializada..."
...
install_options(){
    output "Por favor selecione sua opção de instalação:"
    output "[1] Instale o painel."
    output "[2] Instale o daemon."
    output "[3] Instale o painel e o daemon."
    output "[4] Instale o servidor SFTP autônomo."
    output "[5] Atualize o painel 0.7.x para 0.7.18."
    output "[6] Atualizar daemon 0.6.x para 0.6.13."
    output "[7] Atualize o painel para 0.7.18 e daemon para 0.6.13"
    output "[8] Atualize o servidor SFTP autônomo para 1.0.5."
    output "[9] Torne o Pterodactyl compatível com o aplicativo móvel."
    output "[10] Atualize a compatibilidade móvel."
    output "[11] Instale ou atualize o phpMyAdmin 5.0.2."
    output "[12] Instale um host de banco de dados independente."
    output "[13] Alterar o tema do pterodactyl."
    output "[14] Redefinição de senha raiz de emergência MariaDB."
    output "[15] Redefinição de informações de host de banco de dados de emergência."
    read choice
    case $choice in
        1 ) installoption=1
...
webserver_options() {
    output "Por favor, selecione qual servidor web você gostaria de usar:\n[1] Nginx (recomendado).\n[2] Apache2/httpd."
    read choice
    case $choice in
        1 ) webserver=1
...
theme_options() {
    output "Selecione um tema."
    output "[1] Nenhum tema."
    output "[2] Pterodactyl Traduzido."
    ...
    output ""
    output "Selecione o seu tema."
    read choice
    case $choice in
        1 ) themeoption=1
            output "Voce selecionou pterodacytl traduzido."
            output ""
            ;;
        2 ) themeoption=2
...
theme() {
    ...
    if [ "$themeoption" = "1" ]; then
        ...
        curl https://raw.githubusercontent.com/zGumeloBr/traducao-pt-br-pterodactyl-panel/master/traducao-pterodactyl-pt-br.sh | sh
